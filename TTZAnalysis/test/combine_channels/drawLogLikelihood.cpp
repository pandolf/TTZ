...
int main() {
  ...
  std::string suffix = "0_120613_091632"; 

  DrawBase* db = new DrawBase(suffix);
  db->set_lumi(4980.); 

  std::string fileName = "q_mergedToys_crab_" + suffix + ".root";
  ...
  float yMin = 0.5;
  TH2D* h2_axes = new TH2D("axes", "", 10, 0., xMax, 10, yMin, 5000000.);
  ...
  TLegend* legend = new TLegend( 0.4, 0.7, 0.88, 0.88);
