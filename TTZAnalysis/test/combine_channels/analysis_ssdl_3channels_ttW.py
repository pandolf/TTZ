...
signal_process_groups = {'ttZttWZ': ['ttW']}
#model = higgs_datacard.build_model('datacard_TTWZ_sep_3channels_ttW.txt', filter_channel = filter_chan)
model = higgs_datacard.build_model('datacard_ssdl_3channels_ttW.txt', filter_channel = filter_chan)
